      ...
      <aside className="hidden lg:flex flex-col justify-between mt-[32px] w-[326px] bg-background">
        <div className="w-full aside_links flex flex-col">
          ...
          <div className="w-full navigation aside_links_navigation pl-[28px] flex flex-col gap-[4px] px-[32px] py-[12px]">
            <span className="text-[#A0A2A6] text-[14px] leading-[24px] font-semibold">
              Navigation
            </span>
            <ul>
        ...
        <div className="aside_cta flex flex-col gap-[12px] px-[28px]">
          <div className="cta flex flex-col px-[16px] py-[12px] gap-[10px] bg-white rounded-[12px] border">
