    ...
    return (
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>Go to the next level</DialogTitle>
            <DialogDescription>
              Get the power of the CRM with all the features you need.
            </DialogDescription>
          </DialogHeader>
          <div>
            <p className="text-[#101828] font-semibold text-[24px] leading-[32px]">
              Pro
            </p>
            <p className="text-[#667085] font-semibold text-[18px] leading-[28px]">
              $9.99/month
            </p>
          </div>
          <ul className="leading-[18px] font-semibold flex flex-col gap-3">
            <li> ✅ Unlimited Deals register </li>
            <li> 🎯 Best Ads Campaigns </li>

            <li> ✨ 24/7 support </li>
          </ul>
          <Button className="flex items-center p-2 gap-3">
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent>
        <DrawerHeader className="text-left">
          <DrawerTitle>Go to the next level</DrawerTitle>
          <DrawerDescription>
            Get the power of the CRM with all the features you need.
          </DrawerDescription>
        </DrawerHeader>
